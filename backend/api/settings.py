...
from services.system_settings import (
    ...
    DAILY_AI_LOOP_ENABLED, STRATEGY_REFLECTION_ENABLED, STR_KEYS, INT_KEYS, FLOAT_KEYS)
...
_BOOL_KEYS = {DISCOVERY_ENABLED, AUTONOMOUS_OUTREACH_ENABLED, AUTO_REPLY_ENABLED,
              ACKNOWLEDGMENT_REPLY_ENABLED, DAILY_AI_LOOP_ENABLED, STRATEGY_REFLECTION_ENABLED}
